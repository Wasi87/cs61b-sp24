...
public class LinkedListDeque61BTest {
    ...
    public void get() {
        ...
        assertThat(lld1.get(Integer.MAX_VALUE)).isEqualTo(null);
        assertThat(lld1.get(Integer.MIN_VALUE)).isEqualTo(null);
    }
    ...
    public void getRecursive() {
        ...
        assertThat(lld1.getRecursive(Integer.MAX_VALUE)).isEqualTo(null);
        assertThat(lld1.getRecursive(Integer.MIN_VALUE)).isEqualTo(null);
    }
